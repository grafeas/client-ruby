...
module Grafeas
  ...
  class DockerImageFingerprint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'v1_name')
        self.v1_name = attributes[:'v1_name']
      end

      if attributes.has_key?(:'v2_blob')
        if (value = attributes[:'v2_blob']).is_a?(Array)
          self.v2_blob = value
        end
      end

      if attributes.has_key?(:'v2_name')
        self.v2_name = attributes[:'v2_name']
      end
    end
