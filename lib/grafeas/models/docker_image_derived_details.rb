...
module Grafeas
  ...
  class DockerImageDerivedDetails
    ...
    def self.swagger_types
      {
        ...
        :'distance' => :'Integer',
        :'layer_info' => :'Array<DockerImageLayer>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'layer_info')
        if (value = attributes[:'layer_info']).is_a?(Array)
          self.layer_info = value
        end
      end

      if attributes.has_key?(:'base_resource_url')
        self.base_resource_url = attributes[:'base_resource_url']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          distance == o.distance &&
          layer_info == o.layer_info &&
          base_resource_url == o.base_resource_url
    end
    ...
    def hash
      [fingerprint, distance, layer_info, base_resource_url].hash
    end
