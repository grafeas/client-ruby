...
module Grafeas
  class PackageManagerDistribution
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latest_version')
        self.latest_version = attributes[:'latest_version']
      end

      if attributes.has_key?(:'maintainer')
    ...
    def hash
      [cpe_uri, architecture, latest_version, maintainer, url, description].hash
    end
