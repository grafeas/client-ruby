...
module Grafeas
  ...
  class ApiPgpSignedAttestation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pgp_key_id')
        self.pgp_key_id = attributes[:'pgp_key_id']
      end
    end
    ...
    def hash
      [signature, content_type, pgp_key_id].hash
    end
