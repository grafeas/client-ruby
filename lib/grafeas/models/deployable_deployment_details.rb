...
module Grafeas
  ...
  class DeployableDeploymentDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deploy_time')
        self.deploy_time = attributes[:'deploy_time']
      end

      if attributes.has_key?(:'undeploy_time')
        self.undeploy_time = attributes[:'undeploy_time']
      end
      ...
      if attributes.has_key?(:'resource_uri')
        if (value = attributes[:'resource_uri']).is_a?(Array)
          self.resource_uri = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deploy_time == o.deploy_time &&
          undeploy_time == o.undeploy_time &&
          config == o.config &&
          address == o.address &&
    ...
    def hash
      [user_email, deploy_time, undeploy_time, config, address, resource_uri, platform].hash
    end
