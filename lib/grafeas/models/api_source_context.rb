...
module Grafeas
  ...
  class ApiSourceContext
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cloud_repo')
        self.cloud_repo = attributes[:'cloud_repo']
      end

      if attributes.has_key?(:'gerrit')
        self.gerrit = attributes[:'gerrit']
      end
    ...
    def hash
      [cloud_repo, gerrit, git, labels].hash
    end
